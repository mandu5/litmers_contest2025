  ...
  const refreshIssue = async () => {
    try {
      ...
      if (response.ok) {
        ...
        setSelectedLabels(data.labels?.map((l: Label) => l.id) || []);
          ...
          {isEditing ? (
            <div className="mb-4 space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                {issue.projectLabels?.map((label: Label) => (
              ...
              <>
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    {issue.teamMembers?.map((member: User) => (
                    ...
                    >
                      {isSubtaskLoading === subtask.id ? (
                        ...
                        <Checkbox
                          ...
                          onCheckedChange={() => handleSubtaskToggle(subtask.id, subtask.completed)}
                          disabled={!canEdit}
                          className="h-4 w-4"
                        />
                      )}
            ...
            <CardContent>
              {issue.history && issue.history.length > 0 ? (
                <div className="space-y-3">
                  {issue.history.map((entry: HistoryEntry) => (
                    <div
                      key={entry.id}
                      className="flex gap-3 rounded-lg border border-slate-200 p-3 dark:border-slate-800"
                    >
